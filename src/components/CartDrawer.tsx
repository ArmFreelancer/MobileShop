              ...
              {cart.map(item => (
                ...
                >
                  ...
                  <div className="flex-grow-1 min-w-0">
                    ...
                    <small className="text-muted d-block mb-1" style={{ fontSize: 11, textTransform: 'uppercase' }}>{item.brand}</small>
                    ...
                    <div className="d-flex align-items-center justify-content-between mt-2">
                      <div className="qty-control d-flex align-items-center" style={{ scale: '0.85', transformOrigin: 'left center' }}>
                        <button className="btn btn-sm btn-outline-dark px-2" onClick={() => changeQty(item.id, -1)}>−</button>
